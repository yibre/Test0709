...
int CDataContainer::getValue_UtoP_AorM() { return m_UtoP_AorM; }
int CDataContainer::getValue_UtoP_E_STOP() { return m_UtoP_E_STOP; }
int CDataContainer::getValue_UtoP_GEAR() { return m_UtoP_GEAR; }
int CDataContainer::getValue_UtoP_SPEED() { return m_UtoP_SPEED; }
int CDataContainer::getValue_UtoP_STEER() { return m_UtoP_STEER; }
int CDataContainer::getValue_UtoP_BREAK() { return m_UtoP_BREAK; }
int CDataContainer::getValue_UtoP_ALIVE() { return m_UtoP_ALIVE; }

void CDataContainer::setValue_UtoP_AorM(int value) { m_UtoP_AorM = value; }
void CDataContainer::setValue_UtoP_E_STOP(int value) { m_UtoP_E_STOP = value; }
void CDataContainer::setValue_UtoP_GEAR(int value) { m_UtoP_GEAR = value; }
void CDataContainer::setValue_UtoP_SPEED(int value) { m_UtoP_SPEED = value; }
void CDataContainer::setValue_UtoP_STEER(int value) { m_UtoP_STEER = value; }
void CDataContainer::setValue_UtoP_BREAK(int value) { m_UtoP_BREAK = value; }
void CDataContainer::setValue_UtoP_ALIVE(int value) { m_UtoP_ALIVE = value; }


//PCU to UPPER (ÇÃ·§Æû¿¡¼­ ¹Þ¾Æ¿À´Â °ª)
int CDataContainer::getValue_PtoU_AorM() { return m_PtoU_AorM; }
int CDataContainer::getValue_PtoU_E_STOP() { return m_PtoU_E_STOP; }
int CDataContainer::getValue_PtoU_GEAR() { return m_PtoU_GEAR; }
int CDataContainer::getValue_PtoU_SPEED() { return m_PtoU_SPEED; }
int CDataContainer::getValue_PtoU_STEER() { return m_PtoU_STEER; }
int CDataContainer::getValue_PtoU_BREAK() { return m_PtoU_BREAK; }
int CDataContainer::getValue_PtoU_ALIVE() { return m_PtoU_ALIVE; }
int CDataContainer::getValue_PtoU_ENC() { return m_PtoU_ENC; }

void CDataContainer::setValue_PtoU_AorM(int value) { m_PtoU_AorM = value; }
void CDataContainer::setValue_PtoU_E_STOP(int value) { m_PtoU_E_STOP = value; }
void CDataContainer::setValue_PtoU_GEAR(int value) { m_PtoU_GEAR = value; }
void CDataContainer::setValue_PtoU_SPEED(int value) { m_PtoU_SPEED = value; }
void CDataContainer::setValue_PtoU_STEER(int value) { m_PtoU_STEER = value; }
void CDataContainer::setValue_PtoU_BREAK(int value) { m_PtoU_BREAK = value; }
void CDataContainer::setValue_PtoU_ENC(int value) { m_PtoU_ENC = value; }
void CDataContainer::setValue_PtoU_ALIVE(int value) { m_PtoU_ALIVE = value; }
*/
...
int CDataContainer::getValue_UtoP_E_STOP() { 
    mtx_UtoP_E_STOP.lock(); 
    int temp = m_UtoP_E_STOP; 
    mtx_UtoP_E_STOP.unlock(); 
    return temp; 
}
int CDataContainer::getValue_UtoP_GEAR() { 
    mtx_UtoP_GEAR.lock(); 
    int temp = m_UtoP_GEAR; 
    mtx_UtoP_GEAR.unlock(); 
    return temp; 
}
int CDataContainer::getValue_UtoP_SPEED() { 
    mtx_UtoP_SPEED.lock(); 
    int temp = m_UtoP_SPEED; 
    mtx_UtoP_SPEED.unlock(); 
    return temp; }

int CDataContainer::getValue_UtoP_STEER() { 
    mtx_UtoP_STEER.lock(); 
    int temp = m_UtoP_STEER;
    mtx_UtoP_STEER.unlock(); 
    return temp; }

int CDataContainer::getValue_UtoP_BREAK() { 
    mtx_UtoP_BREAK.lock(); 
    int temp = m_UtoP_BREAK; 
    mtx_UtoP_BREAK.unlock(); 
    return temp; 
}
int CDataContainer::getValue_UtoP_ALIVE() { 
    mtx_UtoP_ALIVE.lock(); 
    int temp = m_UtoP_ALIVE;
    mtx_UtoP_ALIVE.unlock();
    return temp; }
